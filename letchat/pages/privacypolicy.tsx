...
const privacypolicy = () => {
  return (
    <>
      <Head>
        <title>LetChat | Privacy Policy</title>
        <meta
          name="description"
      ...
      <Container>
        <div className=" m-auto my-4 max-w-3xl">
          ...
          <br />
          <p>
            This privacy notice for Git Gud{" "}
          ...
          <p>
            ...
            information depending on how you interact with Git Gud and the
          ...
          <p>
            ...
            available here: http://www.letchat.co.uk/data-request, or by
